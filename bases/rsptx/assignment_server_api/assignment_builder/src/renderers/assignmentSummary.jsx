...
export function AssignmentSummary() {
    ...
    const data = [
        { key: 1, id: 1, title: "Question 1", points: 100, due: "2021-09-01", average: 75.5, min: 0, max: 100 },
        { key: 2, id: 2, title: "Question 2", points: 100, due: "2021-09-01", average: 75.5, min: 0, max: 100 },
        { key: 3, id: 3, title: "Question 3", points: 100, due: "2021-09-01", average: 75.5, min: 0, max: 100 },
    ]
    ...
    return (
        <div>
            <DataTable value={assignData} paginator rows={10} selectionMode="single" selection={selectedRow} onSelectionChange={(e) => {
            ...
            <DataTable value={questionData} paginator rows={10} selectionMode="single" selection={selectedRow} onSelectionChange={(e) => setSelectedRow(e.value)} dataKey="id" >

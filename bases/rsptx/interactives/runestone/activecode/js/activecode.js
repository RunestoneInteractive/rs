...
export class ActiveCode extends RunestoneBase {
    constructor(opts) {
        ...
        this.problem_description =
            $(opts.orig).find(".ac_question").text() || "";
        this.code = $(orig).text() || "\n\n\n\n\n";
        ...
        let promise = new Promise((resolve, reject) => {
            ...
            fetch(
                ...
                .catch((err) => {
                    ...
                    $(loadingBarDiv)
                        .find("#encouragement-text")
                        .text("⚠️ " + timeoutMessage);
                    $(loadingBarDiv)
                        .find("#countdown-text")
                        .text("🫶 Please contact the teaching staff for help!");
    ...
    async parsonsBtnHandler() {
        ...
        let existingLoadingPrompt = $(this.outerDiv).find(
            "#scaffolding-loading-prompt-" + this.divid,
        );
        ...
        $(this.outerDiv)
            .find("#scaffolding-loading-prompt-" + this.divid)
            .removeClass("loading");
        ...
        if (!this.helpLoaded) {
            ...
            if (
                ...
                $(this.outerDiv)
                    .find(".parsons-scaffolding-btn")
                    .text("Regenerate Help");
            }
        }
    }
    ...
    enableHideShow(ctrlDiv) {
        ...
        $(butt).click(
            function () {
                ...
                if (
                    $(this.showHideButt).text() == t("msg_activecode_show_code")
                ) {
                    $(this.showHideButt).text(t("msg_activecode_hide_code"));
                } else {
                    $(this.showHideButt).text(t("msg_activecode_show_code"));
                }
...
Yet another is that there is an internal error.  The internal error message is: ${err.message}`;
    ...
    async manage_scrubber(saveCode) {
        ...
        if (
            ...
            this.history[$(this.historyScrubber).slider("value")] != userCode
        ) {
            saveCode = "True";

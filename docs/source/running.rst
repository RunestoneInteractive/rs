...
- **Docker Desktop** with Docker Compose 2.20.2 or later (current version: 2.38.2)
  ...
  - **Important**: Configure file sharing in Docker Desktop (Settings → Resources → File Sharing) to include the directory where you'll create your Runestone configuration and your ``BOOK_PATH`` directory (example reference in section 6.7). Without this, Docker won't be able to access your book files.
